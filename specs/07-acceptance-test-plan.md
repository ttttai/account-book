...
9. 履歴の「自分の支出」で、支払者にかかわらず負担した取引が抽出され、6,000円の半額負担なら主金額3,000円・取引全体6,000円と表示され、行リンクのアクセシブル名に「〇〇の支出 ￥3,000 取引全体 ￥6,000」が含まれ、行に「支出した人」と両メンバーの表示名が表示され、支払者・「2人で分割」・全幅の「編集」ボタンが表示されず、行のタップで取引編集へ遷移することを確認する。

...
export function getNotifierConfig(): NotifierConfig | null {
  const result = configSchema.safeParse({
    ...
    groupId: process.env.LINE_WEEKLY_REPORT_GROUP_ID,
    jobAudience: process.env.LINE_WEEKLY_REPORT_JOB_AUDIENCE,
    jobInvoker: process.env.LINE_WEEKLY_REPORT_JOB_INVOKER,
  });
